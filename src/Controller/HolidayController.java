...
public class HolidayController {
    ...
    private void addHoliday() {
        ...
        // Calculer la durée du congé demandé en jours
        ...
        try {
            ...
            boolean addReussi = model_holiday.addHoliday(4, id_employe, startDate, endDate, type, targetEmploye);

            if (addReussi) {
                // Réduire le solde de congé après l'ajout réussi
                targetEmploye.setSolde(targetEmploye.getSolde() - (int) daysBetween);
                View.afficherMessageSucces("Le congé a bien été ajouté.");
            } else {
                View.afficherMessageErreur("Le congé n'a pas été ajouté.");
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void deleteHoliday() {
        ...
        if (selectedrow == -1) {
            ...
            int olddaysbetween = (int) ((Date.valueOf(OldendDate).getTime() - Date.valueOf(OldstartDate).getTime()) / (1000 * 60 * 60 * 24)) + 1;
            ...
            if (deletereussi) {
                View.afficherMessageSucces("Le congé a bien été supprimé.");
                displayHoliday();
            } else {
                View.afficherMessageErreur("Le congé n'a pas été supprimé.");
            }
        }
    }
    ...
    private void updateHoliday() {
        ...
        try {
            ...
            if (updateSuccessful) {
                ...
                View.afficherMessageErreur("Erreur lors de la mise à jour du congé.");
            }
        } catch (Exception e) {
